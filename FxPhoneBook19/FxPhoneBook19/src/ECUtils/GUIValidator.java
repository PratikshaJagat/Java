...
public class GUIValidator {
    ...
    public void addAadharValidator(Control tf) {
        ECValidattion.AadharValidator v1 = new ECValidattion.AadharValidator();
        addValidator(tf, v1);
    }
    ...
    public void addNameAndReqValidator(Control tf) {
        ECValidattion.NameAndReqValidator v1 = new ECValidattion.NameAndReqValidator();
        addValidator(tf, v1);
    }
    ...
    public void addWebsiteValidator(Control tf) {
        ECValidattion.WebSiteValidator v1 = new ECValidattion.WebSiteValidator();
        addValidator(tf, v1);
    }
    ...
    public void addValidator(final Control tf, final ECValidattion.ECValidator v1) {
       ...
       if (tf instanceof TextArea) {
            tf.addEventHandler(KeyEvent.KEY_RELEASED, new EventHandler<KeyEvent>() {
                @Override
                public void handle(KeyEvent event) {
                    putValidMsg(tf, v1.validate(((TextArea) tf).getText()));
                }
            });
        }
